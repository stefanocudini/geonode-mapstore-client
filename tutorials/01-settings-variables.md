...
COALESCE_WMS_LAYERS | default behavior for combining adjacent WMS layers coming from the same source into a single GetMap request, reducing the number of requests sent to the server (background layers are excluded) | False
